...
pub enum KeyboardFocusTarget {
    ...
    Popup(PopupKind),
    /// Phase 4: an ext-session-lock-v1 lock surface (the Utumno lockscreen,
    /// for example). Gets keyboard focus for as long as the session stays
    /// locked — see `SpitfireState::locked`.
...
impl<BackendData: Backend> PointerTarget<SpitfireState<BackendData>> for PointerFocusTarget {
    fn enter(
        &self,
    ...
    fn frame(&self, seat: &Seat<SpitfireState<BackendData>>, data: &mut SpitfireState<BackendData>) {
        match self {
...
impl<BackendData: Backend> KeyboardTarget<SpitfireState<BackendData>> for KeyboardFocusTarget {
    fn enter(
        &self,
        seat: &Seat<SpitfireState<BackendData>>,
        data: &mut SpitfireState<BackendData>,
...
impl<BackendData: Backend> TouchTarget<SpitfireState<BackendData>> for PointerFocusTarget {
    fn down(
        &self,
        seat: &Seat<SpitfireState<BackendData>>,
        data: &mut SpitfireState<BackendData>,
    ...
    fn frame(&self, seat: &Seat<SpitfireState<BackendData>>, data: &mut SpitfireState<BackendData>, seq: Serial) {
        match self {
    ...
    fn cancel(&self, seat: &Seat<SpitfireState<BackendData>>, data: &mut SpitfireState<BackendData>, seq: Serial) {
        match self {
...
impl From<KeyboardFocusTarget> for PointerFocusTarget {
    ...
    fn from(value: KeyboardFocusTarget) -> Self {
        match value {
            ...
            KeyboardFocusTarget::LockSurface(surface) => PointerFocusTarget::from(surface.wl_surface()),
        }
    }
}
