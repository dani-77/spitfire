...
pub struct PointerMoveSurfaceGrab<BackendData: Backend + 'static> {
    pub start_data: PointerGrabStartData<SpitfireState<BackendData>>,
    ...
    for PointerMoveSurfaceGrab<BackendData>
{
    fn motion(
        ...
        handle: &mut PointerInnerHandle<'_, SpitfireState<BackendData>>,
    ...
    fn start_data(&self) -> &PointerGrabStartData<SpitfireState<BackendData>> {
        &self.start_data
    }

    fn unset(&mut self, _data: &mut SpitfireState<BackendData>) {}
}

pub struct TouchMoveSurfaceGrab<BackendData: Backend + 'static> {
    pub start_data: TouchGrabStartData<SpitfireState<BackendData>>,
    pub window: WindowElement,
    pub initial_window_location: Point<i32, Logical>,
}
    ...
    for TouchMoveSurfaceGrab<BackendData>
{
    fn down(
        ...
        _handle: &mut smithay::input::touch::TouchInnerHandle<'_, SpitfireState<BackendData>>,
        _focus: Option<(
            <SpitfireState<BackendData> as smithay::input::SeatHandler>::TouchFocus,
            Point<f64, Logical>,
        )>,
    ...
    fn up(
        &mut self,
        data: &mut SpitfireState<BackendData>,
        handle: &mut smithay::input::touch::TouchInnerHandle<'_, SpitfireState<BackendData>>,
    ...
    fn start_data(&self) -> &smithay::input::touch::GrabStartData<SpitfireState<BackendData>> {
        &self.start_data
    }
