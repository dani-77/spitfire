...
Both of these build tag [`v0.2.0`](https://github.com/dani-77/spitfire/releases/tag/v0.2.0)
...
Both files pin `version`/`pkgver` to `0.2.0` and a `checksum`/`sha256sums` for that
