...
Both of these build tag [`v0.1.0`](https://github.com/dani-77/spitfire/releases/tag/v0.1.0)
...
Both files pin `version`/`pkgver` to `0.1.0` and a `checksum`/`sha256sums` for that
